...
function renderAt( node, context, size, fill=undefined ) {
    ...
    else if ( node.tokenType === Tokenizer.Types.LETTER ) context.fillStyle = colors.black;
    else if ( node.tokenType === Tokenizer.Types.GREEK_LETTER ) context.fillStyle = colors.black;
    ...
    else context.fillStyle = colors.black;
